...
const ProductDetails = () => {
  ...
  useEffect(() => {
    ...
    if (foundProduct) {
      ...
      if (
        foundProduct.color3image1
      ) {

        colorVariants.push({
          name:
            foundProduct.colorName3 ||
            "White",

          images: [
            foundProduct.color3image1,
            foundProduct.color3image2 ||
              foundProduct.color3image1,
            foundProduct.color3image3 ||
              foundProduct.color3image1,
          ].filter(Boolean),
        });
      ...
      const updatedProduct = {
        ...
        description:
          ...
          "Premium luxury activewear collection.",
